import { WHATSAPP_URL } from "@/lib/urls";
...
export function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className={cn(
        "fixed bottom-5 right-5 z-[60] flex size-14 items-center justify-center rounded-full sm:bottom-6 sm:right-6",
        "bg-[#25D366] text-white shadow-lg shadow-emerald-950/30",
